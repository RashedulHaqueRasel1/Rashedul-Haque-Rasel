  ...
  return (
    <section id="about" className="py-12 sm:py-16 md:py-20 relative">
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="Rashedul Haque Rasel, MERN Developer, Full Stack Developer, React Developer, Node.js Developer, JavaScript Developer, Bangladeshi Developer, Portfolio"
        />
        ...
        <meta
          property="og:title"
          content="About Rashedul Haque Rasel | MERN Stack Developer"
        />
        <meta
          property="og:description"
          content="Meet Rashedul Haque Rasel – a skilled full stack web developer specializing in the MERN stack. Learn about his background, projects, and education."
        />
        <meta
          property="og:url"
          content="https://rashedul-haque-rasel.vercel.app/about"
        />
        <meta
          property="og:url"
          content="https://www.facebook.com/Rashedul.haque.Rase1/"
        />
        <meta
          property="og:image"
          content="https://i.postimg.cc/qBNdJcLg/Rashedul-Haque-Rasel.jpg"
        />
        <meta
        ...
        <meta
          ...
          content="Explore the personal and professional journey of Rashedul Haque Rasel – a MERN stack developer from Bangladesh."
        />
        <meta
          name="twitter:image"
          content="https://i.postimg.cc/qBNdJcLg/Rashedul-Haque-Rasel.jpg"
        ...
        <link
          rel="canonical"
          href="https://rashedul-haque-rasel.vercel.app/about"
        />
      </Head>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-300 max-w-2xl mx-auto px-4 sm:px-0">
            Get to know more about my background, skills, and journey as a
            developer
          </p>
        </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-4">
                I am Rashedul Haque Rasel, a passionate web developer from
                Bangladesh with a strong focus on building user-friendly and
                responsive web applications. I have hands-on experience with
                front-end technologies like React.js, JavaScript (ES6+), HTML5,
                Tailwind CSS, and back-end tools like Node.js, Express.js, and
                MongoDB. I enjoy solving real-world problems through clean,
                scalable code.
              </p>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                I’m confident in my front-end skills, I’m currently exploring
                backend development more deeply to become a skilled full-stack
                developer. I am always eager to learn new technologies and
              ...
              >
                ...
                <div className="flex-grow ml-4 sm:ml-6 bg-white/5 backdrop-blur-sm border border-white/10 p-4 sm:p-6 rounded-lg shadow-lg">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                    <h4 className="text-lg sm:text-xl font-semibold text-white mb-1 sm:mb-0">
                      {edu.degree}
                    </h4>
